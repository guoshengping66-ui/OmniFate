            ...
            <ScrollReveal delay={0.45}>
              <div className="flex flex-col sm:flex-row gap-4">
                <MagneticButton>
                  <Link
                    href="/reading/new"
                    className="btn-gold text-base inline-flex items-center gap-2 px-10 py-4 text-lg group"
                  >
                    {t("hero.cta1")}
              ...
              <div className="mt-16 flex flex-wrap items-center gap-8 md:gap-12">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
                    <CountUpNumber end={12000} suffix="+" duration={2.5} />
                  </div>
                  <div className="text-[11px] md:text-xs text-white/40 mt-1.5 tracking-wider font-medium">{t("hero.stat1")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
                    <CountUpNumber end={98} duration={2} />.7<span className="text-lg md:text-xl">%</span>
                  </div>
                  <div className="text-[11px] md:text-xs text-white/40 mt-1.5 tracking-wider font-medium">{t("hero.stat2")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
                    <CountUpNumber end={5} duration={1.5} />
                  </div>
                  <div className="text-[11px] md:text-xs text-white/40 mt-1.5 tracking-wider font-medium">{t("hero.stat3")}</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
                    &lt;<CountUpNumber end={40} duration={2} />s
                  </div>
                  <div className="text-[11px] md:text-xs text-white/40 mt-1.5 tracking-wider font-medium">{t("hero.stat4")}</div>
                </div>
              </div>
            </ScrollReveal>
          </div>
