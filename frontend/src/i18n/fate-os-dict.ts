...
export const YI_JI = {
  ...
  动土: { en: "Disruption Warning", tactical: "Avoid destabilizing established structures" },
  ...
  远行: { en: "Long Range Warning", tactical: "Avoid extended field operations" },
  搬迁: { en: "Relocation Risk", tactical: "Postpone base migration" },
  嫁娶: { en: "Union Caution", tactical: "Delay permanent alliances" },
  开市: { en: "Launch Risk", tactical: "Avoid new business activation" },
  交易: { en: "Transaction Alert", tactical: "Pause large-scale exchanges" },
  签约: { en: "Contract Warning", tactical: "Delay agreement execution" },
  修造: { en: "Construction Hazard", tactical: "Avoid infrastructure changes" },
  栽种: { en: "Cultivation Risk", tactical: "Postpone planting operations" },
  出行: { en: "Travel Advisory", tactical: "Stay within operational perimeter" },
  祈福: { en: "Spiritual Interference", tactical: "Avoid energy realignment rituals" },
} as const
...
export const SPECIAL_CONCEPTS = {
  ...
  壁上土: { en: "Wall Earth", attribute: "Protective Structure / Defensive Matrix" },
  金箔金: { en: "Gold Foil Metal", attribute: "Surface Brilliance / Refined Display" },
  ...
  松柏木: { en: "Pine Wood", attribute: "Evergreen Vitality / Timeless Growth" },
  长流水: { en: "Long Flow Water", attribute: "Continuous Motion / Unstoppable Progress" },
  沙中金: { en: "Sand Metal", attribute: "Buried Treasure / Hidden Potential" },
  山下火: { en: "Mountain Base Fire", attribute: "Contained Energy / Strategic Reserve" },
  平地木: { en: "Flatland Wood", attribute: "Steady Advancement / Grounded Progress" },
  壁上土: { en: "Rampart Earth", attribute: "Fortified Defense / Structural Integrity" },
  金箔金: { en: "Gold Leaf Metal", attribute: "Lustrous Surface / Refined Display" },
  钗钏金: { en: "Ornamental Metal", attribute: "Decorative Strength / Functional Beauty" },
  桑柘木: { en: "Mulberry Wood", attribute: "Silk Production / Quiet Resilience" },
  大溪水: { en: "Torrent Water", attribute: "Powerful Surge / Expansive Force" },
  沙中土: { en: "Desert Earth", attribute: "Scattered Foundation / Adaptable Base" },
  山头火: { en: "Summit Fire", attribute: "Visible Influence / Prominent Impact" },
  泉中水: { en: "Spring Source", attribute: "Pure Origin / Regenerative Core" },
  屋上土: { en: "Rooftop Earth", attribute: "Overhead Protection / Coverage Layer" },
  霹雳火: { en: "Lightning Fire", attribute: "Instant Strike / Dramatic Force" },
