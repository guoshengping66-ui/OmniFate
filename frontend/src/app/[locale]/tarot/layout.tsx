...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "塔罗牌分析 — AI 塔罗牌解读与行动指引 | KhanFate" : "Tarot Reading - AI Symbol Card Interpretation | KhanFate",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "塔罗牌分析 — AI 塔罗解读 | KhanFate" : "Tarot Reading - AI Symbol Card Interpretation",
      description: isZh
