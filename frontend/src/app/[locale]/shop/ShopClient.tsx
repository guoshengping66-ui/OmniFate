...
function ShopContent({ seoHero }: ShopClientProps) {
  ...
  const copy = {
    ...
    subtitle: isZh
      ? "这里不是普通商城。KhanFate 会把你的报告标签、五维状态和近期趋势，转化为可执行的生活方式处方。"
      : "This is not a generic shop. KhanFate turns your report tags, five-dimension state, and current trend into practical lifestyle prescriptions.",
    disclaimer: isZh
  ...
  Object.assign(copy, {
    ...
    subtitle: isZh
      ...
      : "Based on your personality structure, emotional state, and life rhythm, KhanFate recommends spatial, personal, and ritual objects.",
    disclaimer: isZh
      ? "KhanFate 不会承诺改变命运。商品为文化创意与生活方式建议，请结合自身需要理性选择。"
      : "Items are cultural and lifestyle recommendations, not guaranteed outcomes. Choose based on your own needs.",
    personalizedTitle: isZh ? "已根据你的 KhanFate 档案重新排序" : "Re-ranked for your KhanFate dossier",
    personalizedDesc: isZh
    ...
    defaultDesc: isZh
      ? "当前展示为精选生活方式物件。完成一次 KhanFate 报告后，系统会生成更适合你的匹配顺序。"
      : "These are curated lifestyle picks. After your first KhanFate report, the system can generate a more personal match order.",
    createProfile: isZh ? "生成我的KhanFate 档案" : "Create my KhanFate dossier",
  ...
  Object.assign(copy, {
    ...
    defaultDesc: isZh ? "完成 KhanFate 报告后，排序会更贴近你的个人节奏。" : "After your KhanFate report, ranking becomes more personal.",
