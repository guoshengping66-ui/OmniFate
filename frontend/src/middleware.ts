...
const publicBlogArticleIds = new Set([
  "wuxing-basics", "bazi-daymaster", "bazi-weakness", "bazi-tengods", "chart analysis-houses",
  "chart analysis-aspects", "symbol-major", "face-reading-basics", "palm-life-line", "crystal-guide",
  "env-desk", "chart analysis-elements", "bazi-marriage", "faq-birthtime", "symbol-repetition",
  "faq-ai-vs-traditional", "bazi-annual", "chart analysis-compatibility", "faq-reading-guide", "face-moles",
  "ziwei-intro", "palm-head-heart", "symbol-reversed", "platform-guide", "five-elements-water-deficiency",
  "rising-sign-guide", "tarot-upright-reversed", "what-is-bazi-reading", "ziwei-doushu-explained",
  "tarot-card-meanings-complete", "face-reading-personality", "palm-reading-lines-guide", "bazi-compatibility-guide",
  "zodiac-love-compatibility-2026", "five-elements-personality-test", "how-to-read-bazi-chart", "what-is-bazi",
  "read-bazi-chart", "five-elements-chinese-astrology", "missing-element-bazi", "birth-chart-self-reflection",
  "bazi-vs-western-astrology", "chinese-metaphysics-beginners", "iching-bazi-fengshui", "tarot-self-reflection-guide",
  "tarot-card-meanings-beginners", "face-reading-cultural-tradition", "palm-reading-beginners",
])

const englishOnlyBlogArticleIds = new Set([
  "what-is-bazi", "read-bazi-chart", "five-elements-chinese-astrology", "missing-element-bazi",
  "birth-chart-self-reflection", "bazi-vs-western-astrology", "chinese-metaphysics-beginners",
  "iching-bazi-fengshui", "tarot-self-reflection-guide", "tarot-card-meanings-beginners",
  "face-reading-cultural-tradition", "palm-reading-beginners",
])
...
export function middleware(request: NextRequest) {
  ...
  // Dynamic route `notFound()` is emitted after the streaming response begins,
  // which Next.js serves as HTTP 200. Reject unknown editorial paths here so
  // crawlers receive a real 404 before any response body is streamed.
  const blogArticleMatch = pathname.match(/^\/(en|zh)\/blog\/([^/]+)$/)
  if (blogArticleMatch) {
    const [, locale, articleId] = blogArticleMatch
    if (!publicBlogArticleIds.has(articleId) || (locale === "zh" && englishOnlyBlogArticleIds.has(articleId))) {
      return new NextResponse("Page Not Found", { status: 404 })
    }
  }
