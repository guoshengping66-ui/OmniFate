  ...
  const steps: Step[] = [
    {
      ...
      titleEn: "Welcome to Destiny Mirror",
      descKey: "onboarding.step1Desc",
      descEn: "AI-powered multi-dimension destiny analysis. You've received 100 Stardust — enough to unlock your first full report!",
    },
    {
      icon: <Star size={28} />,
      ...
      descEn: "Enter your birth date, time, and location. This is the foundation for all destiny calculations.",
      link: "/reading/new",
    ...
    },
    {
      ...
      descEn: "Bazi (八字), Western Astrology, Tarot, Face Reading, and Palmistry — all powered by AI for comprehensive insights.",
    },
    {
      icon: <ShoppingBag size={28} />,
      titleKey: "onboarding.step4Title",
      titleEn: "Discover Destiny Products",
      descKey: "onboarding.step4Desc",
      descEn: "Based on your reading, we recommend crystals, talismans, and services tailored to your destiny blueprint.",
      link: "/shop",
