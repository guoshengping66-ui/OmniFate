...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "事件复盘 — AI 分析关键事件 | KhanFate" : "Event Review - AI Key Event Analysis | KhanFate",
    description: isZh
    ...
    keywords: isZh
      ? "事件复盘,行为分析,关键事件,AI分析,KhanFate"
      : ["event review", "behavioral analysis", "key events", "AI analysis", "KhanFate"],
    openGraph: {
      title: isZh ? "事件复盘 — KhanFate" : "Event Review - KhanFate",
      description: isZh
        ? "AI 从个人成长角度分析关键事件"
