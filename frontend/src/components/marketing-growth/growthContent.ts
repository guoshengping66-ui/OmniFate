...
const zh: GrowthCopy = {
  hero: {
    home: {
      ...
      subtitle: "KhanFate把八字、紫微、星盘、塔罗、面相手相与真实问题放进同一个上下文，输出当下模式、机会窗口、风险提醒和一条可复盘行动。",
      methodLabel: "合参信号",
  ...
  trust: [
    {
      title: "不把命理包装成绝对预测",
      body: "KhanFate用于模式识别、反思和决策辅助，不替代医疗、法律或财务建议。",
    },
...
const en: GrowthCopy = {
  hero: {
    home: {
      ...
      subtitle:
        "KhanFate combines Bazi, Ziwei, astrology, tarot, face and palm signals, and your real question into one context, then returns your pattern, opportunity window, risk signal, and next action.",
  ...
  trust: [
    {
      ...
      body: "KhanFate supports pattern recognition, reflection, and decisions. It does not replace medical, legal, or financial advice.",
    },
    {
