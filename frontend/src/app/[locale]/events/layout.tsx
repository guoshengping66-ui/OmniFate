...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "事件复盘 — AI 分析关键事件 | Inner Atlas AI" : "Event Review - AI Key Event Analysis | Inner Atlas AI",
    description: isZh
    ...
    keywords: isZh
      ? "事件复盘,行为分析,关键事件,AI分析,Inner Atlas AI"
      : ["event review", "behavioral analysis", "key events", "AI analysis", "Inner Atlas AI"],
    openGraph: {
      title: isZh ? "事件复盘 — Inner Atlas AI" : "Event Review - Inner Atlas AI",
      description: isZh
        ? "AI 从个人成长角度分析关键事件"
