      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={0.15}>
          <div className="card-solid p-8 md:p-10 mb-8">
            ...
            <p className="text-parchment-400 text-sm leading-relaxed">{content.developed}</p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <div className="card-solid p-8 md:p-10 mb-8">
            ...
            <p className="text-parchment-400 text-sm leading-relaxed">{content.flat}</p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.25}>
          <div className="card-solid p-8 md:p-10 mb-8">
            ...
            <p className="text-parchment-400 text-sm leading-relaxed">{content.prominent}</p>
          </div>
        </ScrollReveal>
