...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "AI 手相分析 — 智能掌纹解读与行为模式 | KhanFate" : "AI Palm Reading - Intelligent Palm Line Analysis | KhanFate",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "AI 手相分析 — 智能掌纹解读 | KhanFate" : "AI Palm Reading - Intelligent Palm Line Analysis",
      description: isZh
        ? "AI 手相分析，掌纹与行为模式解读"
