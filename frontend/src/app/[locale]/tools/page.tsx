...
const tools = [
  ...
  { icon: Sparkles, title: "Bazi Calculator", titleZh: "八字排盘", desc: "AI-powered Four Pillars chart generation with Five Elements analysis.", descZh: "AI驱动四柱八字排盘，含五行分析。", href: "/bazi", color: "from-amber-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: Stars, title: "Ziwei Doushu", titleZh: "紫微斗数", desc: "Purple Star Astrology chart with 12 life palaces mapping.", descZh: "紫微斗数命盘，十二宫分布与主星定位。", href: "/ziwei", color: "from-purple-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: Sparkles, title: "Tarot Reading", titleZh: "塔罗占卜", desc: "AI tarot card interpretation with multiple spread options.", descZh: "AI塔罗牌解读，支持多种牌阵选择。", href: "/tarot", color: "from-violet-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: ScanFace, title: "Face Reading", titleZh: "面相分析", desc: "AI face analysis for features, shape, and behavioral patterns.", descZh: "AI面相分析：五官特征、脸型与行为模式。", href: "/face-reading", color: "from-cyan-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: Hand, title: "Palm Reading", titleZh: "手相分析", desc: "AI palm line analysis for life, head, heart, and fate lines.", descZh: "AI手相分析：生命线、智慧线、感情线和命运线解读。", href: "/palm-reading", color: "from-amber-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: Sparkles, title: "Five Elements", titleZh: "五行分析", desc: "Discover your elemental balance and generating or overcoming cycles.", descZh: "探索你的五行平衡：相生与相克关系。", href: "/five-elements", color: "from-green-500/10", tag: "Single signal", tagZh: "Single signal" },
  { icon: Orbit, title: "Zodiac Compatibility", titleZh: "星座配对", desc: "AI-powered star sign matching for love, friendship, and work.", descZh: "AI星座配对：恋爱、友谊和工作契合度分析。", href: "/astrology/zodiac-compatibility", color: "from-pink-500/10", tag: "Single signal", tagZh: "Single signal" },
]
