...
export const ARTICLES: Article[] = [
  ...
  // ────────────────────────────────────────────────────
  {
    ...
    summary_zh: "五素是中国行为分析学的基础框架。了解五素的相生相克关系，是理解四柱档案的第一步。本文用最通俗的语言解释五素的本质。",
...
在四柱档案中，每个人的出生时间对应着天干地支，每个天干地支都带有五素属性。通过计算四柱中五素的分布，分析师可以判断你五素的强弱——这就是「五素得分」。
...
你知道自己的日主天干是什么吗？日主天干是四柱中代表你自己的那个字。如果你知道自己的出生年月日时，可以试试我们的 AI 分析工具，一键生成你的五素分析。点击「开始分析」获取你的五素分析报告。`,
...
通过 AI 分析工具，输入你的出生年月日时，系统会自动计算你的四柱四柱，并标注你的日主天干。你还可以看到五素得分、十维关系等详细分析。
    `,
    content_en: `
...
十维是四柱分析中用来描述日主与其他天干之间关系的十个名称。它们基于五素生克关系，进一步细分为：生我者、我生者、克我者、我克者、同我者，每类又分阴阳，共十个。
...
**Q：报告会过时吗？**
基础格局（四柱、图表）不会变，但状态分析（周期、月运）会随时间更新。
...
### 误区二：点了痣就能优化
痣相只是面部特征的一个参考点，点掉一颗痣不会根本改变你的状态。真正的优化需要从五素调和、行为习惯等多方面入手。
...
图表系统起源于唐代，由道家发展完善，是中国传统行为分析学中精度最高的体系之一。它与四柱的最大区别在于：四柱用出生时间推算五素，而图表系统用出生时间排出「档案」，将十四颗主星分布在十二个宫位中。
