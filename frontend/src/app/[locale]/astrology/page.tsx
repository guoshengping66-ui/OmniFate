      ...
      <div className="mx-auto max-w-4xl">
        ...
        <ScrollReveal>
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-sm leading-relaxed text-parchment-400 md:text-base">
              {isZh
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href={localeHref("/reading/new?system=astrology")} className="btn-primary inline-flex items-center gap-2 px-8 py-3 text-sm">
                {isZh ? "生成完整星盘报告" : "Generate full chart report"} <ArrowRight size={18} />
              </Link>
              <Link href={localeHref("/am16")} className="inline-flex items-center gap-2 border border-white/15 px-8 py-3 text-sm text-parchment-300 transition-colors hover:border-gold/30 hover:text-gold">
        ...
        <ScrollReveal delay={0.1}>
          <div className="mb-16 grid gap-4 md:grid-cols-2">
            {features.map((feature) => {
              ...
              return (
                <div key={feature.title} className="card-interactive p-5 transition-all duration-300 hover:border-gold/30">
                  ...
                  <p className="text-sm leading-relaxed text-parchment-400">{feature.desc}</p>
                </div>
              )
            })}
          </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="card-solid mb-16 p-8 md:p-10">
            <h2 className="mb-6 font-serif text-2xl text-gold">
              {isZh ? "星盘应该放在什么位置？" : "Where astrology fits"}
            </h2>
            <div className="space-y-4 text-sm leading-relaxed text-parchment-400">
        ...
        <ScrollReveal delay={0.3}>
          <div className="card-solid-elevated relative overflow-hidden p-10 text-center">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mb-8 max-w-md text-parchment-400">
