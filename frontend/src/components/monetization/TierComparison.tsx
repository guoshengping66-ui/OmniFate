    ...
    <div>
      ...
      <div className="mt-8 card-glass p-5 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
        ...
        <div className="flex-1">
          <p className="text-white/80 font-medium">{t("tierComparison.eventRetrospection")}</p>
          <p className="text-white/40 text-sm">{t("tierComparison.eventDesc").replace("{price}", "¥19.9")}</p>
        </div>
        <button
