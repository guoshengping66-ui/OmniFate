...
export default function PricingPage() {
  ...
  return (
        ...
        "@type": "Product",
        name: "KhanFate - Personal Insight Report",
        ...
        <ScrollReveal>
          <div className="mb-8 text-center">
            ...
            <h1 className="mb-2 font-serif text-2xl font-bold text-white md:text-4xl">
              {isZh ? "选择适合你的 KhanFate分析方式" : "Choose the KhanFate analysis depth that fits you"}
            </h1>
            <p className="mx-auto max-w-2xl text-sm leading-relaxed text-white/38">
              {isZh ? "从免费探索到完整档案，你可以按自己的问题深度选择。KhanFate提供自我认知和生活决策参考，不承诺结果。" : "From free exploration to a complete dossier, choose by the depth of your question. KhanFate offers self-knowledge and decision support, not guaranteed outcomes."}
            </p>
          </div>
        </ScrollReveal>
