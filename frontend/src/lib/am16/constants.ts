...
export const AM16_QUESTIONS: AM16Question[] = [
  // ── FD 维度（3题）──
  {
    ...
    optionA: {
      ...
      dimension: "F", points: 1,
    },
    optionB: {
      text: "纯属意外。迅速格物致知，掏出纸巾擦干，并给市政热线打个电话建议修路",
      dimension: "D", points: 1,
    },
  },
  {
    id: 2,
  ...
  // ── XS 维度（3题）──
  {
    ...
    optionA: {
      ...
      dimension: "X", points: 1,
    },
    optionB: {
      text: "先拉个 Excel 表对比流年大运，看看具体哪个五行出了问题",
      dimension: "S", points: 1,
    },
  },
  {
    id: 5,
  ...
  // ── GI 维度（3题）──
  {
    ...
    optionA: {
      ...
      dimension: "G", points: 1,
    },
    optionB: {
      text: "哦，挺好。（内心：管我屁事，别影响我今晚打坐冥想吸纳天地灵气）",
      dimension: "I", points: 1,
    },
  },
  {
    id: 8,
  ...
  // ── PE 维度（3题）──
  {
    ...
    optionA: {
      ...
      dimension: "P", points: 1,
    },
    optionB: {
      text: "知行合一！现在是凌晨两点，我马上爬起来把 PPT 写完，明天就去拉投资",
      dimension: "E", points: 1,
    },
  },
  {
    id: 11,
