...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "交易日志 — AI 分析交易行为 | KhanFate" : "Trading Journal - AI Trade Analysis | KhanFate",
    description: isZh
    ...
    keywords: isZh
      ? "交易日志,交易分析,AI交易,投资行为,KhanFate"
      : ["trading journal", "trade analysis", "AI trading", "investment behavior", "KhanFate"],
    openGraph: {
      title: isZh ? "交易日志 — KhanFate" : "Trading Journal - KhanFate",
      description: isZh
        ? "AI 分析交易行为模式"
