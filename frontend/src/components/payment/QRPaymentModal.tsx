...
export function QRPaymentModal({
  ...
  useEffect(() => {
    console.log("[QR] paypal_embedded effect:", { status, isShopPayment, shopOrderNo, paypalOrderId })
  ...
  useEffect(() => {
    console.log("[QR] open effect:", { open, isShopPayment, shopOrderNo, method, status })
