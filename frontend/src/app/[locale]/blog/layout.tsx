...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "KhanFate 博客 — 命理知识与 AI 解读 | KhanFate" : "KhanFate Blog: Bazi, Astrology & Tarot Guides | KhanFate",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "KhanFate 博客 — 命理知识与 AI 解读" : "KhanFate Blog: Bazi, Astrology & Tarot Guides",
      description: isZh
        ? "探索八字、星盘、塔罗、面相等命理知识"
