...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "会员方案 — 解锁 AI 成长系统 | Inner Atlas AI" : "Pricing - Unlock Your AI Growth System | Inner Atlas AI",
    description: isZh
    ...
    keywords: isZh
      ? "Inner Atlas AI,会员方案,定价,AI命运画像,每日趋势,个人成长系统"
      : ["Inner Atlas AI", "pricing", "AI destiny profile", "daily trend", "personal growth system"],
    openGraph: {
      title: isZh ? "会员方案 — Inner Atlas AI 成长系统" : "Pricing - Inner Atlas AI Growth System",
      description: isZh
