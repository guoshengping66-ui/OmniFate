...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "星盘分析 — AI 本命星盘解读与相位诊断 | KhanFate" : "Chart Analysis - AI Natal Chart Reading | KhanFate",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "星盘分析 — AI 本命星盘解读 | KhanFate" : "Chart Analysis - AI Natal Chart Reading",
      description: isZh
        ? "AI 星盘分析，行星落位与相位诊断"
