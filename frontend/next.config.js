...
const securityHeaders = [
  ...
  { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.cloudflareinsights.com https://js.stripe.com; style-src 'self' 'unsafe-inline' https://fonts.font.im https://fonts.googleapis.com https://www.gstatic.com; img-src 'self' https: data: blob:; font-src 'self' https://fonts.font.im https://fonts.gstatic.com https://fonts.googleapis.com; connect-src 'self' https://api.khanfate.com https://api.stripe.com https://accounts.google.com; object-src 'none'; base-uri 'self'; form-action 'self' https://checkout.stripe.com; frame-ancestors 'none'; frame-src 'self' https://accounts.google.com https://js.stripe.com https://checkout.stripe.com" },
]
