    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-parchment-400 text-sm">{t("disclaimer.updated")}</p>
        </div>
        ...
        <div className="card-solid p-6 md:p-10 space-y-8">
          ...
          <div>
            ...
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s1Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s2Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s2Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s3Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s3Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s4Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s4Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s5Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s5Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s6Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s6Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s7Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s7Content")}</div>
          </div>

          <div>
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.s8Title")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed whitespace-pre-line">{t("disclaimer.s8Content")}</div>
          </div>

          {/* Operator info */}
          <div className="border-t border-white/[0.06] pt-6">
            <h2 className="text-gold font-medium text-lg mb-3">{t("disclaimer.operatorTitle")}</h2>
            <div className="text-parchment-300 text-sm leading-relaxed space-y-1">
