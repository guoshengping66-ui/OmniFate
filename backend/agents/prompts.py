...
def face_prompt(face_text: str, gender: str, bazi_supplement: str = "") -> str:
    ...
    return (
        ...
        "  - 3-5条可执行的日常改相方法\n\n"
        "写作要求：\n"
        "  - 3000-4500字，引麻衣相法/神相全编/柳庄相法体系，引用预计算数据(五行面型/三庭比例/特征评分/十二宫预评/骨相评分)\n"
...
def palm_prompt(palm_text: str, gender: str, bazi_supplement: str = "",
    ...
    lines = [
        ...
        "",
        "写作要求：",
        "  - 3000-4500字，融合柳庄相法+陈抟老祖秘诀+西洋Cheiro+印度手相四大体系深度",
...
"""
    ...
    return (
        ...
        "   - 提供3-5条可执行的奇门开运方法\n"
        "   - 提醒需要特别注意的风险和化解方式\n\n"
        "9. 文字风格：专业而不晦涩，用中文输出，约2000-3000字。\n"
...
"""
    ...
    return (
        ...
        "  每月的行动建议（适合/不适合做什么）\n\n"
        "写作要求：\n"
        "  - 3500-5500字，专业深入，引《滴天髓》《三命通会》《子平真诠》等经典\n"
...
"""
    ...
    return (
        ...
        "输出要求：中文，洞见温暖权威。免费用户≤1200字，付费用户3500-5000字。\n"
