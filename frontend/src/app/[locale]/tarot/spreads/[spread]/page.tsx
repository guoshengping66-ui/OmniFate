      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={0.1}>
          <div className="card-glass p-8 md:p-10 mb-8">
            ...
            <div className="mt-4 p-4 bg-white/[0.02] rounded-xl border border-white/[0.05]">
              <p className="text-white/40 text-xs">{isZh ? `使用卡片数量：${data.card_count}` : `Cards Used: ${data.card_count}`}</p>
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <div className="card-glass p-8 md:p-10 mb-8">
            ...
            <p className="text-white/60 text-sm leading-relaxed">{isZh ? data.how_to_read_zh : data.how_to_read_en}</p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.25}>
          <div className="card-glass p-8 md:p-10 mb-8">
            ...
            <p className="text-white/60 text-sm leading-relaxed">{isZh ? data.best_for_zh : data.best_for_en}</p>
          </div>
        </ScrollReveal>
