    ...
    <div className="space-y-2.5">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2 md:gap-3">
          <span className="text-[11px] text-red-400/80 font-medium min-w-[40px] md:min-w-[60px] text-right truncate">{left.tag}</span>
          ...
          <span className="text-[11px] text-emerald-400/80 font-medium min-w-[40px] md:min-w-[60px] truncate">{right.tag}</span>
        </div>
