...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "五行分析 — AI 金木水火土元素平衡 | Inner Atlas AI" : "Five Elements Analysis - AI Metal Wood Water Fire Earth | Inner Atlas AI",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "五行分析 — AI 金木水火土平衡 | Inner Atlas AI" : "Five Elements Analysis - AI Metal Wood Water Fire Earth",
      description: isZh
        ? "AI 五行分析，发现你的元素平衡"
