...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: isZh ? "紫微斗数 — AI 紫微星盘分析与宫位解读 | KhanFate" : "Purple Star Astrology - AI Zi Wei Dou Shu Analysis | KhanFate",
    description: isZh
    ...
    openGraph: {
      title: isZh ? "紫微斗数 — AI 紫微星盘分析 | KhanFate" : "Purple Star Astrology - AI Zi Wei Dou Shu Analysis",
      description: isZh
