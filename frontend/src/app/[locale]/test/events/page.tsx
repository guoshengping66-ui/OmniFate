    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-serif font-bold text-gold">事件复盘</h1>
            <p className="text-parchment-400 text-sm mt-1">回顾关键事件，分析因果与未来趋势</p>
          </div>
          <TargetSelector />
        </div>
        ...
        <div className="card-solid p-8 text-center">
          ...
          <p className="text-parchment-400 text-sm">事件复盘功能即将上线</p>
