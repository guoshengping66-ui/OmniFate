      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <Link href={localeHref("/")} className="flex items-center gap-2.5 group flex-shrink-0">
            <img src="/logo-dark.png" alt="命盘智镜" className="w-9 h-9 rounded-full object-cover shadow-[0_0_20px_rgba(201,168,76,0.3)] group-hover:scale-110 transition-transform" />
