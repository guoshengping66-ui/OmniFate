"""
fortune_generator.py — 每周分析生成服务

根据用户数据 + 当前日期 + 塔罗牌生成个性化每周分析。
"""
import hashlib
import random
...
AI_INSIGHTS_ZH = [
    "本周{yi}运势旺盛，结合你的数据分析，建议把握周中黄金时段推进重要事务。周末宜休整，为下周蓄力。",
    "本周{yi}运势平稳，整体协调，适合按部就班推进计划。注意周五可能有小波折。",
    "本周{ji}需谨慎，但{yi}运强劲，可主动出击。保持心态平和，好运自来。",
    "本周整体流向对你有利，{yi}方向有贵人出现。建议多社交，拓展人脉。",
    "本周需注意{ji}方面，但整体运势向好。保持耐心，好事多磨。",
]
AI_INSIGHTS_EN = [
    "This week's {yi} outlook is strong. Based on your data analysis, we recommend tackling important tasks mid-week. Rest on the weekend to recharge.",
    "This week's {yi} outlook is steady and balanced. Stick to your plan. Watch out for minor setbacks on Friday.",
    "Be cautious with {ji} this week, but {yi} energy is strong — take initiative. Stay calm and good things will come naturally.",
    "The overall flow favors you this week. Look for allies in the {yi} direction. Expand your network.",
    "Watch out for {ji} this week, but overall outlook is positive. Patience is key.",
]
