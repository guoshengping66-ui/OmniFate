        ...
        <ScrollReveal delay={0.2}>
          <div className="card-solid p-8 md:p-10 mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {lines.map((l) => (
                <div key={l.name} className="flex items-center gap-3 p-4 bg-white/[0.03] rounded-xl border border-white/[0.06]">
                  <span className="text-2xl">{l.icon}</span>
                  <div>
                    <h3 className="text-white font-medium text-sm">{l.name}</h3>
                    <p className="text-parchment-400 text-xs">{l.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <ScrollReveal delay={0.5}>
          <div className="text-center card-solid-elevated p-10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-parchment-400 text-xs mt-4">{t("seo.palm.ctaNote")}</p>
            </div>
          </div>
        </ScrollReveal>
      </div>
